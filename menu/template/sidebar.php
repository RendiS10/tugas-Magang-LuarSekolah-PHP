...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="height: 100vh; position: fixed; width: 250px;">
    ...
    <div class="collapse navbar-collapse" id="sidebarMenu">
        <ul class="navbar-nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../admin/keloladataguru.php">
                    <i class="fas fa-chalkboard-teacher"></i> Kelola Data Guru
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../admin/kelolaprogram.php">
                    <i class="fas fa-book-open"></i> Kelola Program Pelatihan
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" onclick="showFeatureUnavailableAlert()">
