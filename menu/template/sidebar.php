...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="height: 100vh; position: fixed; width: 250px;">
    ...
    <div class="collapse navbar-collapse" id="sidebarMenu">
        <ul class="navbar-nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../admin/keloladata.php">Kelola Data Peserta</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../admin/keloladataguru.php">Kelola Data Guru</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../admin/kelolaprogram.php">Kelola Program Pelatihan</a>
            </li>
            <li class="nav-item">
